...
# from CRSP
if(!file.exists('data/ass3_sp500_constituents_with_daily_mdata.rds')){
  
  # get SP500 constituents with daily market data from 2015-01-01,
  ...
  saveRDS(sp500, 'data/ass3_sp500_constituents_with_daily_mdata.rds')
} else {
  sp500 <- readRDS('data/ass3_sp500_constituents_with_daily_mdata.rds')
}
...
if(!file.exists('data/ass3_ibes_eps_forecasts.rds')){
  ...
  saveRDS(aneps, 'data/ass3_ibes_eps_forecasts.rds')
} else {
  aneps <- readRDS('data/ass3_ibes_eps_forecasts.rds')
}
...
if(!file.exists('data/ass3_cmp_fundamentals.rds')){
  ...
  saveRDS(cmp, 'data/ass3_cmp_fundamentals.rds')
} else {
  cmp <- readRDS('data/ass3_cmp_fundamentals.rds')
}
...
arrow::write_feather(sp500, 'data/assignment_3_sp500_constituents_with_daily_mdata.feather')
arrow::write_feather(aneps, 'data/assignment_3_ibes_eps_analyst_estimates.feather')
arrow::write_feather(cmp, 'data/assignment_3_cmp_fundamentals.feather')
